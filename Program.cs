...
builder.Services
    ...
    .AddScoped<IGDBCompanyService>()
    .AddScoped<IGDBLanguageService>()
    .AddScoped<IGDBGameTypeService>()
    .AddScoped<IGDBInvolvedCompanyService>()
    .AddScoped<IGDBLanguageSupportService>()
